...
public class HouseBean {
	...
	private String h_aname;
	private String h_email;
	private String h_address;
	private String h_tel;
	private String h_file;
	private String h_fileFileName;
	private int h_level;
	private int h_rate;
	...
	public String getH_fileFileName() {
		return h_fileFileName;
	}

	public void setH_fileFileName(String h_fileFileName) {
		this.h_fileFileName = h_fileFileName;
	}
	...
	public String getH_aname() {
		return h_aname;
	}

	public void setH_aname(String h_aname) {
		this.h_aname = h_aname;
	}
	...
	public String toString() {
		return "HouseBean [h_no=" + h_no + ", h_name=" + h_name + ", h_category=" + h_category + ", h_aname=" + h_aname
				+ ", h_email=" + h_email + ", h_address=" + h_address + ", h_tel=" + h_tel + ", h_file=" + h_file
				+ ", h_fileFileName=" + h_fileFileName + ", h_level=" + h_level + ", h_rate=" + h_rate + ", h_lat="
				+ h_lat + ", h_long=" + h_long + "]";
	}
