					...
					<div id="content_body">
						...
						<div class="bbs_box">
							<dl class="bbs_field_row">
								...
								<dd class="bbs_cell bbs_data_cell strong_r">${info.ct_title}</dd>
							</dl>
							<dl class="bbs_field_row">
								<dt class="bbs_cell bbs_field_cell">작성일</dt>
								<dd class="bbs_cell bbs_data_cell">${info.ct_regdate}</dd>
							</dl>
							<dl class="bbs_field_row">
								<dt class="bbs_cell bbs_field_cell">작성자</dt>
								<dd class="bbs_cell bbs_data_half_cell">${info.m_name}</dd>
								<dt class="bbs_cell bbs_field_cell">조회수</dt>
								<dd class="bbs_cell bbs_data_half_cell">${info.ct_hit}</dd>
							</dl>
							<dl class="bbs_field_row">
								<dt class="bbs_cell bbs_field_cell">첨부파일</dt>
								<dd class="bbs_cell bbs_data_cell">${info.ct_file}</dd>
							</dl>
							<dl class="bbs_field_row bbs_content_size">
								<dt class="bbs_cell bbs_field_cell">내용</dt>
								<dd class="bbs_cell bbs_data_cell">${info.ct_contents}</dd>
							</dl>
						</div>
						<div class="rtl vspace10">
							<a class="btn_style btn_list" href="/howstay/admin/adnotice.action">목록</a> <a
								class="btn_style btn_edit" href="userEdit.html">수정</a> <a
								class="btn_style btn_del" href="/howstay/jsp/admin/board/adminDelTour.do?ct_no=${info.ct_no}">삭제</a>
						</div>								
