				...
				<div id="bodyWrapper">
					<div id="content_body">
						...
						<ul class="location_box">
							...
							<li class="location_item">STEP 생성</li>
						</ul>
						<div class="col-md-4">
							<form action="/howstay/admin/adminCreate.action" name="adminMemberFrm"
								method="post">
								<table>
									<tr>
										<td>
											<div class="input-group">
												...
												<input type="text" name="a_id" class="form-control" size="15" />
											</div>
										</td>
									</tr>
									...
									<tr>
										<td>
											<div class="input-group">
												...
												<input type="password" name="a_password" class="form-control" size="15" />
											</div>
										</td>
									</tr>
									<tr>
										<td>
											<div class="input-group">
												...
												<input type="text" name="a_name" class="form-control" size="15" />
											</div>
