				...
				<div id="bodyWrapper">
					<div id="content_body">
						...
						<c:forEach var="i" items="${list}">
							<tr align="center">
									<td style="text-align: center">${i.cq_no}</td>
									<td style="text-align: center">
									<a href="/howstay/jsp/admin/board/adminQaInfo.do?cq_no=${i.cq_no }">${i.cq_title}</a></td>
									<td style="text-align: center">${i.m_name}</td>
									<td style="text-align: center">${i.cq_regdate}</td>
									<td style="text-align: center">${i.cq_hit}</td>
									<td>
									<a href="/howstay/jsp/admin/board/adminQaDel.do?cq_no=${i.cq_no }"><input type="button" value="삭제"></a>
									</td>
								</tr>
							</c:forEach>
					</table>
