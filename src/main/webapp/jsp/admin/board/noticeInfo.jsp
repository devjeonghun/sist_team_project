					...
					<div id="content_body">
						...
						<div class="bbs_box">
							<dl class="bbs_field_row">
								...
								<dd class="bbs_cell bbs_data_cell strong_r">${Info.cn_title}</dd>
							</dl>
							<dl class="bbs_field_row">
								<dt class="bbs_cell bbs_field_cell">작성일</dt>
								<dd class="bbs_cell bbs_data_cell">${Info.cn_regdate}</dd>
							</dl>
							<dl class="bbs_field_row">
								...
								<dd class="bbs_cell bbs_data_half_cell">${Info.cn_hit}</dd>
							</dl>
							<dl class="bbs_field_row">
								<dt class="bbs_cell bbs_field_cell">첨부파일</dt>
								<dd class="bbs_cell bbs_data_cell">${Info.cn_file}</dd>
							</dl>
							<dl class="bbs_field_row bbs_content_size">
								<dt class="bbs_cell bbs_field_cell">내용</dt>
								<dd class="bbs_cell bbs_data_cell">${Info.cn_contents}</dd>
							</dl>
						</div>
						<div class="rtl vspace10">
							<a class="btn_style btn_list" href="/howstay/jsp/admin/board/adnotice.do">목록</a> <a
								class="btn_style btn_edit" href="#">수정</a> <a
								class="btn_style btn_del" href="/howstay/jsp/admin/board/adnoticeDel.do?cn_no=${Info.cn_no}">삭제</a>
						</div>
