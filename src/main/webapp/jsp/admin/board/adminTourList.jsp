					...
					<div id="content_body">
						...
						<div class="bbs_box">
							<ul class="bbs_row bg_hl">
								...
								<!-- <li class="bbs_cell split bbs_col_delete">삭제</li> -->
							</ul>
							<c:forEach var="i" items="${list}">
							<ul>
								<li class="bbs_row"><span class="bbs_cell bbs_col_seq">${i.ct_no}</span>
									<span class="bbs_cell split bbs_col_title">
									<a href="/howstay/jsp/admin/board/adminInfoTour.do?ct_no=${i.ct_no}&page=1">${i.ct_title}</a></span>
									<span class="bbs_cell split bbs_col_writer">${i.m_name}</span>
									<span class="bbs_cell split bbs_col_regdate">${i.ct_regdate}</span>
									<span class="bbs_cell split bbs_col_hit">${i.ct_hit}</span>
									<%-- <span class="bbs_cell split bbs_col_delete">
									<a href="/howstay/jsp/admin/board/adminDelTour.do?ct_no=${i.ct_no }"><input type="button" value="삭제"></a>
									</span> --%>
								</li>
							</ul>
							</c:forEach>
